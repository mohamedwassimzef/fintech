...
public class ExpenseDAO implements CrudInterface<Expense> {
    ...
    public List<Expense> getExpensesByBudgetId(int budgetId) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(query)) {
            ...
            System.out.println("Error getting expenses by budget ID: " + e.getMessage());
        }
    ...
    public List<Expense> getExpensesByCategory(String category) {
        List<Expense> expenses = new ArrayList<>();
        String query = "SELECT * FROM expense WHERE category = ?";
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(query)) {
            ...
            System.out.println("Error getting expenses by category: " + e.getMessage());
        }
